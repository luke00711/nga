...
class StringTypeWidget extends StatelessWidget {
  final String? title;
  final String? subTitle;
  final  String?  values;
  final Function? onTap;

  const StringTypeWidget({Key? key, this.title, this.subTitle, this.values, this.onTap}) : super(key: key);
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 68.dp, child: SelectionWidget(text: values, onTap: onTap))
        ],
      ),
    );
  }
